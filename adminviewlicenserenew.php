<?php
	...
	$result=mysqli_query($database, "SELECT * FROM licenserenew ORDER BY status ASC");
	...
	$rows = mysqli_num_rows($dislicren);
		...
		{
			$displaylicren = "SELECT * FROM licenserenew ORDER BY firstname ASC";
			$dislicren = mysqli_query($database, $displaylicren);
		}
?>
        ...
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">View Applications<span class="caret sr-only">(current)</span></a>
            <ul class="dropdown-menu" role="menu">
              ...
              <li class="active"><a href="adminviewlicenserenew.php" ><i class="fas fa-address-card"></i>   License Renewal</a></li>
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                echo "<tr>
                  ...
                  <td><div class='btn-group col-md-1' role='group'>
  					<a class='btn btn-secondary' href='approvelicenserenew.php?id=".$custid."'>Approve</a>
  					<a class='btn btn-secondary' href='denylicenserenew.php?id=".$custid."'>Decline</a>
  					<a class='btn btn-secondary' href='deletelicenserenew.php?id=".$custid."'>Delete</a>
				  </div></td>
                </tr>";
            }
            ?>
