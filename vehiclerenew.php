...
<head>
	...
	<title>Vehicle Renew | eLANDTRANSPO</title>
        ...
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Select Transaction<span class="caret sr-only">(current)</span></a>
            <ul class="dropdown-menu" role="menu">
              ...
              <li class="active"><a href="vehiclerenew.php" ><i class="fas fa-cogs"></i>   Vehicle Renewal</a></li>
             </ul> 
          </li>
          <li class="nav-item">
    ...
    <div class="row text-white">
      <div class="col-sm-6 offset-sm-3 text-center">
        <h1 class="display-4">Vehicle Renew</h1>
          <div class="info-form">
            <form action="vehiclerenewdatabase.php" method="post" class="form-horizontal justify-content-center">
              ...
              <div class="form-group col-md-10">
                <label class="control-label col-md-12">Model</label>
                <input type="text" class="form-control" name="model" placeholder="Model" required>
              </div>
              <div class="form-group col-md-10">
                <label class="control-label col-md-12">Plate No.</label>
                <input type="text" class="form-control" name="plateno" placeholder="Plate #" required>
              </div>
