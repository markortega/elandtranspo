<?php
  ...
  $res = mysqli_query($database, "SELECT * FROM customer WHERE custid='$custid'");
  while($resRow = mysqli_fetch_array($res)) {
    $email = $resRow['email'];
  }

  $result1=mysqli_query($database, "SELECT * FROM vehiclerenew WHERE email='$email' ORDER BY status ASC");
  $result2=mysqli_query($database, "SELECT * FROM licenserenew WHERE email='$email' ORDER BY status ASC");
  $result3=mysqli_query($database, "SELECT * FROM newlicense WHERE email='$email' ORDER BY status ASC");
?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fas fa-user"></i>  <?php echo $firstname ?><span class="caret sr-only">(current)</span></a>
            <ul class="dropdown-menu" role="menu">
  ...
  <div id="container" class="container">
    <div class="row text-white">
      <div class="col-md-auto">
        <h1 class="display-4">Vehicle Renew</h1>
              ...
              while($row = mysqli_fetch_array($result1)) {
                ...
                echo "<tr>
                  ...
                  <td><div class='btn-group col-md-1' role='group'>
                    <a class='btn btn-secondary' href='clientdeletevehiclerenew.php?id=".$custid."'>Cancel</a>
                  </div></td>
                </tr>";
            }
            ?>
            ...
            <?php
              while($row = mysqli_fetch_array($result2)) {
                ...
                echo "<tr>
                  ...
                  <td>".$status."</td>
                  <td><div class='btn-group col-md-1' role='group'>
                    <a class='btn btn-secondary' href='clientdeletelicenserenew.php?id=".$custid."'>Cancel</a>
                  </div></td>
                </tr>";
            }
            ?>
        ...
        <h1 class="display-4">New License</h1>
          ...
          <thead class="thead-dark">
            <tr>
              ...
              <th scope="col">Gender</th>
              <th scope="col" class="col-md-auto">Birthday</th>
            ...
            <?php
              while($row = mysqli_fetch_array($result3)) {
                ...
                echo "<tr>
                    ...
                    <td>".$gender."</td>
                    <td>".$bday."</td>
                    <td class='col-md-auto'>".$address."</td>
                    <td>".$status."</td>
                    <td><div class='btn-group col-md-1' role='group'>
                    <a class='btn btn-secondary' href='clientdeletenewlicense.php?id=".$custid."'>Cancel</a>
                  </div></td>
                  </tr>";
              }
            ?>
