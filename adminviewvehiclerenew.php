<?php
	...
	$result=mysqli_query($database, "SELECT * FROM vehiclerenew ORDER BY status ASC");
?>
        ...
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">View Applications<span class="caret sr-only">(current)</span></a>
            <ul class="dropdown-menu" role="menu">
              ...
              <li class="active"><a href="adminviewvehiclerenew.php" ><i class="fas fa-cogs"></i>   Vehicle Renewal</a></li>
             </ul> 
          </li>
          <li class="nav-item">
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                echo "<tr>
                  ...
                  <td><div class='btn-group col-md-1' role='group'>
  					<a class='btn btn-secondary' href='approvevehiclerenew.php?id=".$custid."'>Approve</a>
  					<a class='btn btn-secondary' href='denyvehiclerenew.php?id=".$custid."'>Decline</a>
  					<a class='btn btn-secondary' href='deletevehiclerenew.php?id=".$custid."'>Delete</a>
				  </div></td>
                </tr>";
            }
            ?>
