...
<head>
	...
	<title>New License | eLANDTRANSPO</title>
        ...
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Select Transaction<span class="caret sr-only">(current)</span></a>
            <ul class="dropdown-menu" role="menu">
              <li class="active"><a href="newlicense.php" ><i class="far fa-address-card"></i>   New License</a></li>
    ...
    <div class="row text-white">
      <div class="col-sm-6 offset-sm-3 text-center">
        <h1 class="display-4">New License</h1>
          <div class="info-form">
            <form action="newlicensedatabase.php" method="post" class="form-horizontal justify-content-center">
