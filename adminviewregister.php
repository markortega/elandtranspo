<?php
	...
	$result=mysqli_query($database, "SELECT * FROM customer ORDER BY firstname ASC");
?>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="adminviewregister.php">Registered Users<span class="sr-only">(current)</span></a>
          </li>
